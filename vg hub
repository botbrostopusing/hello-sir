...
local function RUN()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(workspace.Cafe["Door Light 02"].Part1CanCollide.Position)
end
...
local Tab1 = Window:CreateTab("kuromi spooky ")
...
local Toggle1 = Section1:CreateToggle("AutoFarm candy", Settings.ea, function(State)
Settings.ea = State
spawn(
    function()
        while wait() and Settings.ea do
            wait(Settings.ea)
            pcall(
                function()
...
local Toggle1 = Section1:CreateToggle("Auto escape kuromi spooky", Settings.E, function(State)
Settings.E = State
spawn(
    function()
...
Section3:CreateLabel("Credits work#6896")
Section3:CreateLabel("Credits AlexR32#3232 Ui")
Section3:CreateLabel("Credits ewrwrewrwe213343")
